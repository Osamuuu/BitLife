 ...
 * @author Osamu
 */
public class PlyActions implements Serializable{
    private int ncrt;
    ...
    public int getIncreaseCredibility() {
        return this.increaseCredibility;
    }
    ...
    public int getIncreaseMotivation() {
        return this.increaseMotivation;
    }
